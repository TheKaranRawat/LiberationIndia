...
*/
infantry_units = [
    ["B_T_Soldier_F",0,0,0],                                           // Rifleman
    ["B_T_Soldier_LAT_F",0,0,0],                                       // Rifleman (AT)
    ["B_T_Soldier_GL_F",0,0,0],                                        // Grenadier
    ["B_T_Soldier_AR_F",0,0,0],                                        // Autorifleman
    ["B_T_soldier_M_F",0,0,0],                                         // Marksman
    ["B_T_Soldier_AT_F",0,10,0],                                       // AT Specialist
    ["B_T_Soldier_AA_F",0,10,0],                                       // AA Specialist
    ["B_T_Medic_F",0,0,0],                                             // Combat Life Saver
    ["B_T_Engineer_F",0,0,0],                                          // Engineer
    ["B_T_Soldier_Exp_F",0,0,0],                                       // Explosives Specialist
    ["B_T_Recon_F",0,0,0],                                             // Recon Scout
    ["B_T_Recon_LAT_F",0,0,0],                                         // Recon Scout (AT)
    ["B_T_Recon_M_F",0,0,0],                                           // Recon Marksman
    ["B_T_Recon_Medic_F",0,0,0],                                       // Recon Paramedic
    ["B_T_Recon_exp_F",0,0,0],                                         // Recon Demolition Expert
    ["B_T_Sniper_F",0,0,0],                                            // Sniper
    ["B_T_ghillie_tna_F",0,0,0],                                       // Sniper (Jungle)
    ["B_T_Spotter_F",0,0,0],                                           // Spotter
