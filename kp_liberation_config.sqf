...
GRLIB_secondary_missions_costs = [8, 5, 3];                             // Intel price for the secondary missions [FOB hunting, Convoy ambush, SAR].
...
GRLIB_sector_cap = 60;                                                 // Cap for sector defenders.
GRLIB_battlegroup_cap = 100;                                            // Cap for enemy battlegroups.
GRLIB_patrol_cap = 60;                                                 // Cap for enemy patrols.
...
KP_liberation_civinfo_min = 1000;                                       // Civil Informant minimum spawn time. (seconds)
KP_liberation_civinfo_max = 2000;                                       // Civil Informant maximum spawn time. (seconds)
KP_liberation_civinfo_chance = 85;                                      // Civil Informant spawn chance. (0-100)
KP_liberation_civinfo_intel = 5;                                        // Civil Informant intel amount.
KP_liberation_civinfo_duration = 5000;                                  // Civil Informant staytime until despawning. (seconds)
KP_liberation_civinfo_task_chance = 40;                                 // Chance (0-100) that the delivered informant will spawn a time critical task.
KP_liberation_civinfo_task_duration = 2000;                              // Duration until the task will despawn if no player is near. (seconds)
