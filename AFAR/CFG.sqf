...
*///CONFIGURATIONS:
//CHANNEL PERMISSIONS
r_sCH=[TRUE,TRUE];//Air Channel ~ Chat/Voice  						>> Default: [FALSE,TRUE]
...
r_sCHName="OVERLORD";//Name of the custom channel		>> Default: "Air Channel"
r_sCHShort="(HQ)";//Displayed by player name in Air channel >> Default: "(Air)"
