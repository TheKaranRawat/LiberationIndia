	...
	_soundvolume = soundvolume;
		...
		if(_key isEqualto GF_Earplugs_key) then {
			...
			if (!(_musicvolume isEqualto 0.1) or !(_soundvolume isEqualto 0.1))then{
				...
				titleText ["<t color='#339933' size='1'font='PuristaBold'>EARPLUGS IN</t>", "PLAIN DOWN", -1, true, true];	
				1 fadeSound 0.1;
			...
			if ((_musicvolume isEqualto 0.1) or(_soundvolume isEqualto 0.1))then{		
				...
				titleText ["<t color='#FF3333' size='1'font='PuristaBold'>EARPLUGS OUT</t>", "PLAIN DOWN", -1, true, true];	
